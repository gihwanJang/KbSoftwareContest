package com.example.myapplication.homeui.map;
...
import com.example.myapplication.homeui.notification.NotificationMapFragment;
...
public class GpsSplashActivity extends AppCompatActivity {
    private static final String TAG = GpsSplashActivity.class.getSimpleName();
        ...
        settingsClient.checkLocationSettings(builder.build())
                .addOnSuccessListener(this, new OnSuccessListener<LocationSettingsResponse>() {
                    ...
                    public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(GpsSplashActivity.this);
                        fusedLocationProviderClient.requestLocationUpdates(locationRequest, locationCallback, null);
                    }
                })
                .addOnFailureListener(GpsSplashActivity.this, new OnFailureListener() {
                    @Override
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                try {
                                    ...
                                    rae.startResolutionForResult(GpsSplashActivity.this, GPS_UTIL_LOCATION_RESOLUTION_REQUEST_CODE);
    ...
    private LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            Intent intent = new Intent(GpsSplashActivity.this, MainActivity.class);
